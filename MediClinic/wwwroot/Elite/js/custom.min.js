    ...
    $(window).ready(e),
        ...
        $(".sidebartoggler").on("click", function () {
            $("body").hasClass("mini-sidebar")
                ? ($("body").trigger("resize"), $("body").removeClass("mini-sidebar"), $(".navbar-brand span").show(), $(".header-1").hide(), $(".header-2").show())
                : ($("body").trigger("resize"), $("body").addClass("mini-sidebar"), $(".navbar-brand span").hide(), $(".header-1").show(), $(".header-2").hide());
        }),
...
$(function () {
    var set = function () {
        ...
        if (width >= 1366  && (!div.is(':hidden'))) {

            $("body").removeClass("wp-menu fixed-layout skin-green-dark ");
            $("body").addClass("wp-menu fixed-layout skin-green-dark mini-sidebar ");
...
{
    $("." + element + "").slideDown(50), $("." + element + "").toggleClass("shw-rside");
