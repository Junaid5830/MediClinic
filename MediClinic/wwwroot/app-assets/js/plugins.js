...
$(function () {
    ...
    $(".nav-collapsible .navbar-toggler").click(function () {
        ...
        if ($(".sidenav-main").hasClass("nav-expanded") && $(".sidenav-main").hasClass("nav-lock")) {
            // $(".sidenav-main").toggleClass("nav-lock");
            // alert("hide button full show");
            ...
            $(".brand-logo2").removeClass("brand-logo");
            $(".brand-logo2").hide();
            ...
            $(".sidenav-main.nav-collapsible, .navbar .nav-collapsible")
                .removeClass("nav-lock");
            $(".firstNavBarList").removeAttr("id");
            $(".nav-collapsed .brand-sidebar .navbar-toggler").css("visibility", "visible");
            $(".brand-sidebar .logo-wrapper a.navbar-toggler").css("position", "initial");
            $(".sideBarCollapseIcon").css("margin-left", "19px");
            $(".sideBarCollapseIcon").css("margin-top", "0px");
            $(".sidenav-dark").css("background-color", "#1d7fed");
            //$(".brand-sidebar .brand-logo").css({ "margin": "0px !important", "padding": "0px !important"});
            $(".ps__thumb-x, .ps__thumb-y").css("background-color", "#fff");
            $(".firstNavBarList").css("margin-left", "70px");
            $(".sidenav-dark.sidenav-main .sidenav li > a > i").css("color", "#ffffff");
            $("#slide-out > li.open > a")
                .parent()
                .addClass("close")
                .removeClass("open");
            ...
            // $(".sidenav-main").toggleClass("nav-lock");
            //alert("show button full hide");
            var navwidht2 = $('.navbar-width').width();
            if (navwidht2 >= 500) {
                $(".header-2").show();
                $(".heading-1").hide();
            }
