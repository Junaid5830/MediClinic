...
*/
   ...
   var doughnutBilling = $("#doughnut-billing-chart");
   ...
   var doughnutBilling = {
      type: "doughnut",
       options: browserStatsBilling,
       data: doughnutSalesBilling
   };
...
*/
   ...
   window.onload = function() {
      ...
      var doughnutSalesChart = new Chart(doughnutSalesChartCTX, doughnutSalesChartConfig);
       var doughnutBillingChart = new Chart(doughnutBilling, doughnutBilling);
