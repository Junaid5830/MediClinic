...
$(function () {
    ...
    $('body').on('keydown', '.ui-autocomplete-input', function (e) {
...
function FeatureNotImplemented() {
    swal("This feature will be implemented before next demo.");
}
...
$(function () {
    ...
    $('.vitalBloodPressure').mask("999/99");
    $('.vitalHeight').mask("9'99\"");
    $('.vitalTemprature').mask("999 °F");
    $('.vitalOxygenSaturation').mask("99 %");
    $('.vitalWeight').mask("999 lbs");
    $('.vitalRespiration').mask("99 per/min");
    $('.vitalPulse').mask("99 per/min");
...
$(document).ready(function () {
    window.onclick = function (event) {
        ...
        if (window.location.pathname == "/patientside/patientinfo" || window.location.pathname == "/PatientSide/PatientInfo") {
            ...
            var firmName = $('.FirmNameCombo').val();
            var leadingParalegalNameCombo = $('.leadingParalegalNameCombo').val();
            var secondaryProviderNameCombo = $('.secondaryInsuranceProviderCombo').val();
            var nf2ComboVal = $('#Patient_nf2Status').val();
            var CaseType = $("#Patient_caseType").val();
            var piLegal = $("#PI_legalStatus").val();
            var PiFirmName = $("#PIFirmName").val();
            var paralegal = $("#PI_leadingParalegalName").val();
            var firmComboVal = $('.FirmNameCombo').val();
            var leadingParalegalName = $('.leadingParalegalNameCombo').val();
            var webPage = $(".webPageUrl").val();
            var SecwebPage = $(".SecwebPageUrl").val();
            var piwebPage = $(".PiwebPageUrl").val();
            var colwebPage = $(".ColwebPageUrl").val();
            if (colwebPage) {
                $("#Colweb_err").html("");
            }
                if (webPage) {
        ...
        if (window.location.pathname == "/Provider/ProviderInfo" || window.location.pathname == "/Provider/ProviderInfo") {
    ...
    $(document).on('submit', '#patientArbitrationAttorneyForm', function (e) {
    ...
    $(document).on('submit', '#patientTeritaryInsurance', function (e) {
        debugger;
    ...
    $(document).on('submit', '#PatientSecondaryInsuranceForm', function (e) {
...
$(document).ready(function () {
    ...
    $(document).on('submit', '#patientPersonalInjuryForm', function (e) {
...
function enablePatientEmergencyFields() {
    ...
    $(".emergencyDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", false);
    $(".emeregencySelect_tab .custom-combobox-input").autocomplete("option", { disabled: false });
...
function disablePatientEmergencyFields() {
    ...
    $(".emergencyDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
...
function enablePatientSignatureFields() {
    $(".signatureDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", false);
...
function disablePatientSignatureFields() {
    $(".signatureDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
...
function disablePatientvehicleFields() {
    $(".vehicleDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
...
function enablePatientsecondaryFields() {
    ...
    $(".secondaryDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", false);
...
function disablePatientsecondaryFields() {
    ...
    $(".secondaryDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
...
function enablePatientTertiaryFields() {
    ...
    $(".TertiaryDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", false);
...
function disablePatientTertiaryyFields() {
    ...
    $(".TertiaryDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
...
function disablePatientPIFields() {
    ...
    $(".PIDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
...
function disablePatientCollectionFields() {
    ...
    $(".CollectionDropDListBeforeEditDisabled").closest(".ui-widget").find("input, button").prop("disabled", true);
